  ...
  def __init__(self, base_net, name='rpn_fpn'):
    ...
    self._net_map = {
                  #  'C1':'resnet_v1_50/conv1/Relu:0',
                   'C2':'resnet_v1_50_2/block1/unit_2/bottleneck_v1',
                   'C3':'resnet_v1_50_2/block2/unit_3/bottleneck_v1',
                   'C4':'resnet_v1_50_2/block3/unit_5/bottleneck_v1',
                   'C5':'resnet_v1_50_2/block4/unit_3/bottleneck_v1',
      }
    self._net_begin = 2
